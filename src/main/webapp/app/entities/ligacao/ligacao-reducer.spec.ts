...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ligacao.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LIGACAO_LIST actions', async () => {
    ...
    it('dispatches FETCH_LIGACAO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LIGACAO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LIGACAO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LIGACAO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LIGACAO actions', async () => {
      const expectedActions = [
        {
